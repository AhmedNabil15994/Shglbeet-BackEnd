    ...
    <div class="page-content"
        ...
        <div class="container position-relative">
            @foreach (config('laravellocalization.supportedLocales') as $localeCode => $properties)
                ...
                @endif
            @endforeach
            <a class="btn btn-success " style="color: white" href="{{route("vendor.home")}}">@lang("Vendor dashboard")</a>
                    ...
                    <div class="app-description text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center share-buttons">
                            ...
                            @if (config('setting.social.youtube'))
                                <a class="rounded-circle instagram"
                                   href="{{ config('setting.social.youtube') ?? '#' }}">
                                    <span class="fab fa-youtube"></span>
                                </a>
                            @endif

                            @if (config('setting.social.linkedin'))
                                <a class="rounded-circle twitter"
                                   href="{{ config('setting.social.linkedin') ?? '#' }}">
                                    <span class="fab fa-linkedin"></span>
                                </a>
                            @endif

                            @if (config('setting.social.tiktok'))
                                <a class="rounded-circle instagram"
                                   href="{{ config('setting.social.tiktok') ?? '#' }}">
