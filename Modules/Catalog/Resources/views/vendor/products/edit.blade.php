                                        ...
                                        @foreach (config('translatable.locales') as $code)
                                            <div id="global_setting{{ $code }}"
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2">
                                                            {{ __('catalog::vendor.products.form.preparation_time') }}
                                                            - {{ $code }}
                                                        </label>
                                                        <div class="col-md-9">
                                                            <input type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="portlet">
                                            <div class="portlet-body">
                                                @include('catalog::vendor.products.components.categories-tree.tree')
                                            </div>
                                        </div>
                                    </div>
                                </div> --}}
            ...
            if (rowCountsArray.length > 1) {
                ...
                if (flag === 'db') {
                    ...
                    if (r == true) {
                        ...
                        $.ajax({
                            url: "{{ route('vendor.products.delete_product_image') }}?id=" + rowId,
                            type: 'get',
                            dataType: 'JSON',
                            contentType: false,
                            cache: false,
